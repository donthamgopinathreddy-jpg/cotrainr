...
7. Privacy Policy, Terms, account deletion, Data Safety, Health Apps declaration, and permission disclosures match audited runtime behaviour.
8. Notification, messaging, video, health, partner, events, restricted-account and deep-link flows pass real-device tests.
