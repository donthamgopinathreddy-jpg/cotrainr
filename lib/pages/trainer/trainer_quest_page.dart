...
class TrainerQuestPage extends StatefulWidget {
  const TrainerQuestPage({super.key});

  @override
  State<TrainerQuestPage> createState() => _TrainerQuestPageState();
}

class _TrainerQuestPageState extends State<TrainerQuestPage>
