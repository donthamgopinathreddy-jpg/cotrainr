...
import 'trainer_theme.dart';

class TrainerOverviewSection extends StatelessWidget {
  final int totalClients;
  final int pendingRequests;
  final List<TrainerClientPreview> recentClients;
  final VoidCallback? onViewAllClients;

  const TrainerOverviewSection({
    super.key,
    ...
    return Row(
      children: [
        ShaderMask(
          ...
          child: const Icon(Icons.fitness_center_rounded, size: 20, color: Colors.white),
        ),
