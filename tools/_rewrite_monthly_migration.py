...
out = Path(__file__).resolve().parents[1] / (
    "supabase/migrations/20260808_monthly_connection_request_quotas.sql"
)

text = r"""-- Monthly connection-request quotas (calendar month).
...
# Normalize newlines; forbid non-ascii
text = text.replace("\r\n", "\n").replace("\r", "\n")
text.encode("ascii")
